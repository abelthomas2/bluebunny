...
export default function OnboardingCarousel({ items }: { items: OnboardingStep[] }) {
  ...
  return (
    <div className="mt-8 mx-auto max-w-4xl px-4">
      ...
      <div className="relative rounded-2xl border border-[#E2EEF5] bg-white shadow-sm min-h-[13rem]">
        ...
        <div className="px-10 py-7">
          ...
          <p className="mt-2 text-sm font-mono leading-relaxed text-[#0C1014]">{step.description}</p>
        </div>
