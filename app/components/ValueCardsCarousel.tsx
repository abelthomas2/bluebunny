...
export default function ValueCardsCarousel({ items }: { items: ValueCard[] }) {
  ...
  return (
    <div className="mt-6 mx-auto max-w-4xl px-4">
      ...
      <div className="relative rounded-2xl border border-[#E2EEF5] bg-white shadow-sm min-h-[10rem]">
